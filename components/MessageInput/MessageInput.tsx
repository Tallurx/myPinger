    ...
    >
      <View style={styles.inputContainer}>
        ...
        <TextInput 
          ...
          placeholder="Pingr message..."
        />
        
        {!message && <Feather name="camera" size={24} color="#595959" style={styles.icon} />}
        {!message && <MaterialCommunityIcons name="microphone-outline" size={24} color="#595959" style={styles.icon} />}
      </View>
